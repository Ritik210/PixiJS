...
**Your profile**: Unity/C# developer, 5 years experience, slot prototype dev
**Starting point**: Zero TypeScript, zero PixiJS, zero modern web tooling
**Time budget**: 2–3 hours/day, 6 days/week = ~15 hrs/week, ~180 hrs total
**End state**: One polished, deployed HTML5 slot prototype. Portfolio-ready. Freelance-capable.
...
- **Exercise**: Model slot domain objects:
  ```ts
  interface Symbol { id: string; name: string; payouts: number[]; }
  interface ReelStrip { symbols: Symbol[]; }
  interface Paytable { /* your design */ }
  ```
